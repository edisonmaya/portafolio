...
const PersonalDescription = () => {
    return (
        <article id="PersonalDescription" className="max-w-[70vh] h-[100vh] m lg:max-w-[85vh] p-8 mt-16 flex flex-col gap-10 justify-center text-white font-Sen font-bold break-words">
            <h2 className="text-2xl Mobile:text-3xl sm:text-3xl "><span className="text-[#9BA4ED] ">Hi! </span> I´m a FullStack<p>Web Developed.</p></h2>
