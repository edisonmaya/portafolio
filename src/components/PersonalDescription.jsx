...
const PersonalDescription = () => {
    return (
        <article id="PersonalDescription" className="max-w-[70vh] h-[100vh] Mobile:mt-8 lg:max-w-[85vh] p-8  flex flex-col gap-10 justify-end Mobile:justify-end 2xl:justify-center text-white font-Sen font-bold break-words">
