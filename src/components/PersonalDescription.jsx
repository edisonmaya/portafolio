...
const PersonalDescription = () => {
    return (
        <article id="PersonalDescription" className="max-w-[70vh] h-[100vh] my-auto lg:max-w-[85vh] p-8  flex flex-col gap-10 justify-end 2xl:justify-center text-white font-Sen font-bold break-words">
            ...
            <button className="invisible w-max px-5 py-10 border-2 text-sm  font-normal rounded-lg xl:text-xl">Click here</button>
        </article>
    )
}
